    ...
    class WPEX_Theme_Options
    {
        ...
        public static function create_admin_page()
        {
			...
			<div class="wrap">
				...
				<h1><?php esc_html_e('Theme Settings', 'text-domain'); ?></h1>
				...
				<form method="post" action="options.php">
					...
					<table class="form-table wpex-custom-admin-login-table">
						...
						<tr valign="top">
							<th scope="row"><?php esc_html_e('Company Name', 'text-domain'); ?></th>
							<td>
								<?php $value1 = self::get_theme_option('input_example1'); ?>
								<input type="text" name="theme_options[input_example1]" value="<?php echo esc_attr($value1); ?>">
							</td>
                        </tr>
                        ...
                        <tr valign="top">
							...
							<td>
								<?php $value2 = self::get_theme_option('input_example2'); ?>
								<input type="text" name="theme_options[input_example2]" value="<?php echo esc_attr($value2); ?>">
							</td>
                        </tr>
                        ...
                        <tr valign="top">
							...
							<td>
								<?php $value3 = self::get_theme_option('input_example3'); ?>
								<input type="text" name="theme_options[input_example3]" value="<?php echo esc_attr($value3); ?>">
							</td>
						</tr>
                        ...
                        <tr valign="top">
							...
							<td>
								<?php $value4 = self::get_theme_option('input_example4'); ?>
								<input type="text" name="theme_options[input_example4]" value="<?php echo esc_attr($value4); ?>">
							</td>
						</tr>
